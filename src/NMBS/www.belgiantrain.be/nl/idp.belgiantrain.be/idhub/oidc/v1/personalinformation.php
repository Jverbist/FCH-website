...
<head>
<title>Mijn NMBS - je persoonlijke gegevens</title>
<!-- Adobe Static Data Layer -->
<script>
dataLayer = [{event: "pageload", environment: "www.belgiantrain.be", platform: "desktop", page: {
       path: "/my-account/personalinformation", language: "nl", siteSections: "[my-account,personalinformation]", query: "",
...
<meta property="og:url" content="personalinformation.php"/>
<meta property="og:type" content="website" />
<meta property="og:locale" content="nl-NL" />
<meta property="og:title" content="Mijn NMBS - je persoonlijke gegevens"/>
...
<ul class="navigation-bar__items">
                <li class="navigation-bar__item ">
                    <a class="navigation-bar__item-link " href="/NMBS/www.belgiantrain.be/nl/search.html">ticket kopen</a>
                </li>
                <li class="navigation-bar__item ">
                    <a class="navigation-bar__item-link " href="/NMBS/www.belgiantrain.be/nl/support/customer-service.html">klantendienst</a>
                </li>
                <li class="navigation-bar__item ">
...
nl        </a>
        <ul class="dropdown__list">
                <li class="dropdown__item">
                    <a href="/fr/my-account/personalinformation">fr</a>
                </li>
                <li class="dropdown__item">
                    <a href="/en/my-account/personalinformation">en</a>
                </li>
                <li class="dropdown__item">
                    <a href="/de/my-account/personalinformation">de</a>
                </li>
        </ul>
    </div>
</div>
...
<div id="resultssh"></div>
        ...
        <!-- Search SDK script -->
            <script src="https://sdk.inbenta.io/search/1.39/inbenta-search-sdk.js"></script>
        <!-- KM SDK script -->
        <!-- SDK initialization -->
        <script type="text/javascript">

           function HideSearchResultsWhenUsingAutocompleter() {
                // hide search results when clicking km auto completer
                var kmAutocompleteItem = document.getElementsByClassName('inbenta-km__autocompleter')[0];
                var searchResults = document.getElementsByClassName('inbenta-search-results')[0];
                var pagination = document.getElementsByClassName('inbenta-search-pagination')[0];

                if (kmAutocompleteItem != null) {
                    kmAutocompleteItem.addEventListener('click', function () {
                        if (searchResults != null && pagination != null) {
            ...
            function ShowSearchResultsAfterUsingAutocompleter() {
                // hide search results when clicking km auto completer
                var searchResults = document.getElementsByClassName('inbenta-search-results')[0];
                var pagination = document.getElementsByClassName('inbenta-search-pagination')[0];
            ...
            function SetAutocompleterEvents() {
                // attach auto completer events on search box click
                var inbentaKmSearchBox = document.getElementsByClassName('inbenta-km-input')[0];

                if (inbentaKmSearchBox != null) {
                    inbentaKmSearchBox.addEventListener('click', function () {
                        HideSearchResultsWhenUsingAutocompleter();
                        });
                }
            }

            function SetFocusWhenPaging() {
                setTimeout(function () {
                    // attach focus events after results load
                    var paginationItems = document.querySelectorAll('.inbenta-search-pagination a');

                    // This is the ID of the container
                    var inbentaWrapper = document.getElementsByClassName('inbenta-search-results')[0];
                    var inbentaWrapperRect = inbentaWrapper.getBoundingClientRect();
                    var bodyRect = document.body.getBoundingClientRect();

                    // Offset
                    var offset = 100;

                    Array.prototype.forEach.call(paginationItems,
                        function(paginationItem) {
                            paginationItem.addEventListener('click',
                                function() {
                                    window.scrollTo(0, inbentaWrapperRect.top - bodyRect.top - offset);
                                    SetFocusWhenPaging();
                                });
                        });
           ...
           function SetResultsAtrributes() {
               setTimeout(function() {
                       // set the role attr to the results list
                       document.querySelectorAll('.inbenta-search-results')[0].setAttribute("role", "list");
                       var nodeList = document.querySelectorAll('.inbenta-search-results__item');
                       nodeList.forEach((element) => {
                           element.setAttribute("role", "listitem");
                       });

                       // set the tabindex and expandable attrs to the results list
                       var faqList = document.querySelectorAll('.inbenta-km__faq__title');
                       faqList.forEach((element) => {
                           element.setAttribute("aria-expandable", "true");
                           element.setAttribute("tabindex", "0");
                       });
                }, 2000);
           }

           function TransformSpanToButton() {
               setTimeout(function() {
                   var buttons= document.querySelectorAll('.inbenta-km-button');
                   if (buttons != null && buttons.length > 0){
                       changeTag(buttons[0], 'button');
                   }
               }, 1000);
           }
           ...
           function changeTag (node, tag) {
               ...
               var clone = document.createElementNS('http://www.w3.org/1999/xhtml', tag);
           ...
           function SetKmResultsFocus() {
               var kmResults = document.querySelectorAll('.inbenta-km__faq .inbenta-km__faq__title');

               Array.prototype.forEach.call(kmResults,
                   function(kmResult) {
                       kmResult.addEventListener('click',
                           function() {
                               SetFocusWhenPaging();
                           });
                   });
           ...
           function SetAnalyticsData(q) {
            ...
            // set-up Inbenta KM Sdk
            

            // set-up Inbenta KM components
            

            // set-up Inbenta Search Sdk
            var sSdk = InbentaSearchSDK.createFromDomainKey('eyJ0eXBlIjoiSldUIiwiYWxnIjoiUlMyNTYifQ.eyJwcm9qZWN0Ijoibm1ic19zZWFyY2hfbmwiLCJkb21haW5fa2V5X2lkIjoiQllDeng0RXp0NDlOZVpLUVA0T2VVUTo6In0.X4kKXD9Zmee2vO1OTRF_ighNg3O4nY1jl-OOtz0pFtvEXjs_T7s6MyZqqSXZ4bo_kTUEZuT250juKgwZiwFvxg', 'q73o+/y81MMHaHe+0I2bG92ErOar5hcmAkM2a6s9rs8=', {"userType":0,"environment":"production","labels":{"SEARCH_BOX_PLACEHOLDER":"Vul je zoektermen in","RESULTS_TEXT":"Résultats pour","RESULTS_BACK_BUTTON":"Précédent","RESULTS_NOT_FOUND_TITLE":"Aucun résultat","RESULTS_NOT_FOUND_TEXT":"Désolé, nous n'avons pas trouvé de résultats pour votre recherche.","NO_RESULTS_NOT_FOUND_HEADER":"Aucun résultat","NO_RESULTS_NOT_FOUND_TITLE":"Désolé, nous n'avons pas trouvé de résultats pour votre recherche.","NO_RESULTS_NOT_FOUND_SUBTITLE":"Veuillez essayer avec d'autres mots-clés.","POPULAR_TITLE":"Popular","PUSH_TITLE":"Push","CATEGORIES_TITLE":"Categories","CATEGORIES_BREADCRUMB_HOME":"Home","RATINGS_INTRODUCTION":"Cette réponse a été utile ?","RATINGS_COMMENT_INTRODUCTION":"Pourquoi ce contenu n’est pas correct ?","RATINGS_SUBMIT_COMMENT_BUTTON":"Envoyer","RATINGS_GRETTINGS_TEXT":"Merci pour votre commentaire.","RATINGS_COMMENT_PLACEHOLDER":""}});

            // set-up Inbenta search components
            var searchboxsh = sSdk.component('search-box', '#search-boxsh', {
    autofocus: false,
    "autocompleter": {
            "filters": false,
            "maxResults": 5,
    ...
    searchCallback: function(query) {
            window.location.href = '/nl/support/search-website?search='+query
        }
  });
var autocompletersh = sSdk.component('autocompleter', '#autocompletersh', {});
var resultssh = sSdk.component('results', '#resultssh', {});


            // set-up components linkage
            resultssh.linkTo(searchboxsh);

            // search on Sdk same time as for Km
            

            // pre-search if query contains key
            var urlParams = new URLSearchParams(window.location.search);
            var searchParam = urlParams.get('search');
            if (searchParam != null) {
                // search only if query value is present
                
                SetAnalyticsData(searchParam);

                // set pagination focus on results from query
                SetFocusWhenPaging();
            }

            TransformSpanToButton();
        </script>
</div>
...
var resultssh = sSdk.component('results', '#resultssh', {});
  ...
  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-arrow-right" />
                                ...
                                <li class="navigation__links-item ">
                                    <a href="/nl/my-account/fiscalattest" class="link"><svg class="icon icon--12" data-id="{80C55728-AA43-4FE6-B2D8-451B4EAF188A}" focusable="false" role="img">
  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-arrow-right" />
                    ...
                    <li class="">
                        <a class="no-underline " href="mycompas.html">Compensatie-aanvragen</a>
                            ...
                            <li>
                                    <hr>
                    <li value="logout.php">
                        <a href="logout.php" class="with-icon">
                            <svg class="icon icon--20" data-id="{9B3025E2-F5AE-4C7F-8461-F7130EDC6865}" focusable="false" role="img">
  <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#icon-logout" />
</svg>
                            Uitloggen
...
<div class="container">
    <div class="wrapper">
        <div id="personalForm" class="marg-bottom-sm-30 marg-bottom-md-40">
            <h2 class="display-inline-block">
                Mijn persoonlijke gegevens
            </h2>
            <a href="javascript:void(0);" aria-label="" class="marg-left-sm-10 js-personal-edit-button  personal-view-link">
                Bewerken
            </a>
            <div id="personal-view" class="js-personal-view ">
                <strong><?php echo $firstName . ' ' . strtoupper($lastName); ?>&#160;</strong><br />
                <?php echo $email ?><br />
                <?php echo $bday ?><br />
				<?php echo $credit_card_number ?><br />
            </div>
            <div id="personal-edit" class="js-personal-edit display-none marg-top-sm-20">
                <form action="/api/myaccountinfo/PersonalInfo" method="post">

                    <input name="__RequestVerificationToken" type="hidden" value="_jfRAaJ16_JupICRU5pzlG5x_eE4D5YvCuBd14RQv1H7Ekza64TgBZQEvh6TQgIdTcd9RONrWpKqPZ1Az0kUNc__PZZSSw83pg9KCXpyvIlA6JUz1ipD3CN7kNHEV4MdZNCIS-KWWyJoRr06wfxRFQ2" />

                    <input type="hidden" name="ParameterEmailMaxLength" id="ParameterEmailMaxLength" value="100" />

                    <div class="input input--hasvalue marg-bottom-sm-10">
                        <label class="input__lbl" for="FirstName">Voornaam</label>
                        <input autocomplete="given-name" class="input__txt&#32;js-input" data-val="true" data-val-length="Dit&#32;is&#32;te&#32;lang" data-val-length-max="30" data-val-regex="Je&#32;vulde&#32;een&#32;ongeldige&#32;voornaam&#32;in." data-val-regex-pattern="^[-a-zA-ZàäâáèëêéïîíšòöôóùüûúÿýçćñœÀÄÂÁÈËÊÉÏÎÍŠÒÖÔÓÙÜÛÚŸÝÇĆÑŒß]+(([&#39;&#32;-][a-zA-ZàäâáèëêéïíîšòöôóùüûúÿýçćñœÀÄÂÁÈËÊÉÏÎÍŠÒÖÔÓÙÜÛÚŸÝÇĆÑŒß])?[a-zA-ZàäâáèëêéšïíîòöôóùüûúÿýçćñœÀÄÂÁÈËÊÉÏÎÍŠÒÖÔÓÙÜÛÚŸÝÇĆÑŒß]*)*$" data-val-required="Je&#32;vergat&#32;je&#32;voornaam&#32;in&#32;te&#32;vullen." id="FirstName" name="FirstName" type="text" value="Kenneth" />
                        <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="FirstName" data-valmsg-replace="true"></span>
                    </div>
                    <br>
                    <div class="input input--hasvalue marg-bottom-sm-10">
                        <label class="input__lbl" for="LastName">Naam</label>
                        <input autocomplete="family-name" class="input__txt&#32;js-input" data-val="true" data-val-length="Dit&#32;is&#32;te&#32;lang" data-val-length-max="30" data-val-regex="Je&#32;vulde&#32;een&#32;ongeldige&#32;naam&#32;in." data-val-regex-pattern="^[-a-zA-ZàäâáèëêéïîíšòöôóùüûúÿýçćñœÀÄÂÁÈËÊÉÏÎÍŠÒÖÔÓÙÜÛÚŸÝÇĆÑŒß]+(([&#39;&#32;-][a-zA-ZàäâáèëêéïíîšòöôóùüûúÿýçćñœÀÄÂÁÈËÊÉÏÎÍŠÒÖÔÓÙÜÛÚŸÝÇĆÑŒß])?[a-zA-ZàäâáèëêéšïíîòöôóùüûúÿýçćñœÀÄÂÁÈËÊÉÏÎÍŠÒÖÔÓÙÜÛÚŸÝÇĆÑŒß]*)*$" data-val-required="Je&#32;vergat&#32;je&#32;naam&#32;in&#32;te&#32;vullen." id="LastName" name="LastName" type="text" value="Van&#32;Velthoven" />
                        <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="LastName" data-valmsg-replace="true"></span>
                    </div>
                    <br>
                    <div class="input marg-bottom-sm-10">
                        <label class="input__lbl" for="Email">E-mailadres</label>
                        <input autocomplete="email" class="input__txt&#32;js-input" data-previousEmail="omgt2k@hotmail.com" data-val="true" data-val-conditionalrequiredvalidator="Dit&#32;is&#32;te&#32;lang" data-val-conditionalrequiredvalidatorafterconditionalfield="ParameterEmailMaxLength" data-val-conditionalrequiredvalidatoraftertype="MAX_LENGTH" data-val-conditionalrequiredvalidatorconditionalfield="Email" data-val-conditionalrequiredvalidatorempty="False" data-val-conditionalrequiredvalidatortype="HAS_VALUE" data-val-regex="Je&#32;vulde&#32;een&#32;ongeldig&#32;e-mailadres&#32;in." data-val-regex-pattern="^[_a-zA-Z0-9-\+]+(\.[_a-zA-Z0-9-\+]+)*@[a-zA-Z0-9-]+(\.[a-zA-Z0-9-]+)*(\.[a-zA-Z]{2,})$" data-val-required="Je&#32;vergat&#32;je&#32;e-mailadres&#32;in&#32;te&#32;vullen." id="Email" name="Email" type="text" value="omgt2k@hotmail.com" />
                        <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="Email" data-valmsg-replace="true"></span>
                    </div>
                    <br>
                    <div class="datepicker js-datepicker label-arrows" data-minage="12"
                         data-mindate="0001-01-01"
                         data-maxdate="2024-07-02">
                        <div class="input input--hasvalue marg-bottom-sm-10">
                            <label class="input__lbl" for="Birthday">Geboortedatum</label>
                            <input autocomplete="bday" class="input__txt" data-val="true" data-val-date="The&#32;field&#32;Geboortedatum&#32;must&#32;be&#32;a&#32;date." data-val-datemustbeinthepast="Je&#32;geboortedatum&#32;kan&#32;niet&#32;in&#32;de&#32;toekomst&#32;liggen." data-val-required="Geboortedatum&#32;*" id="Birthday" name="Birthday" placeholder="Kies&#32;een&#32;datum" type="text" value="30/10/1983" />
                            <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="Birthday" data-valmsg-replace="true"></span>
                        </div>
                    </div>
                    <div class="chk hasParentConsent hide">
                        <input class="chk__input&#32;js-validation" data-val="true" data-val-parentalconsent="&#32;Toestemming&#32;van&#32;de&#32;ouder&#32;is&#32;vereist." data-val-required="The&#32;HasParentConsent&#32;field&#32;is&#32;required." id="HasParentConsent" name="HasParentConsent" type="checkbox" value="true" /><input name="HasParentConsent" type="hidden" value="false" />
  ...
  <path class="input-checkmark__check" fill="none" d="M14.1 27.2l7.1 7.2 16.7-16.8"></path>
                        ...
                        <label for="HasParentConsent" class="chk__lbl">
                            
                            <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="HasParentConsent" data-valmsg-replace="true"></span>
                        </label>
                        <input data-val="true" data-val-required="The&#32;IsBirthDateChanged&#32;field&#32;is&#32;required." id="IsBirthDateChanged" name="IsBirthDateChanged" type="hidden" value="False" />
                    </div>
            ...
            <button class="btn btn--secondary     link--nopad  js-submit-edit btn--full marg-top-sm-40 hide-desktop" type="button" >
                
                Opslaan
            </button>
        <button class="btn btn--secondary     link--nopad  js-submit-edit  marg-bottom-sm-40 marg-top-sm-40 hide-mobile" type="button" >
            ...
            Opslaan
                    ...
                    <input id="DataSourceId" name="DataSourceId" type="hidden" value="{13DB0D09-901A-46DA-B223-5B77792C03E2}" />
                </form>
            </div>
        </div>
    </div>
...
<div class="js-save-popup">
        <div id="save-popup" class="theme-whitetheme-white, hide no-startendmargin" data-label-close="">
            <h2>Opgeslagen data</h2>
            <p>We hebben een e-mail naar je nieuwe adres gestuurd om het te bevestigen.</p>
        </div>
</div>
...
<div class="container-content">Je gegevens (naam, voornaam en geboortedatum) aanpassen kan:<br />
- via <a href="/nl/support/forms/modify-personal-data">het contactformulier</a>, als je een gevalideerd My NMBS-account hebt.<br />
- op deze pagina als je account nog niet gevalideerd is.</div>


<div class="container">
    <div class="wrapper">
        <div class="marg-bottom-sm-30 marg-bottom-md-40 ">
            <h2 class="display-inline-block">
                Mijn adres
            </h2>
            <a href="javascript:void(0);" aria-label="" class="marg-left-sm-10 js-private-address-edit-button  personal-view-link">
	            Bewerken
            </a>

                <div id="private-address-view" class="js-private-address-view ">
<?php echo nl2br(str_replace(',', "\n", $address)); ?><br />
<?php echo $phone_number ?><br />

                                    </div>

            <div id="private-address-edit" class="js-private-address-edit display-none marg-top-sm-20 marg-bottom-sm-10">
                <form class="form-private-address" action="/api/myaccountinfo/PrivateAddressInfo" id="privateAddressInfo" method="post">

                    <input name="__RequestVerificationToken" type="hidden" value="892GxaEBHU4z3UEblT1O0Dv0HPtOSagmc9DKeCOAQbHgc0TRV3qPsW_nMT6YBLBxtl741veswGlLsSYSiFqV70F92EgvNlG9nRD1MHD1wE_MqXdMEgq7LGifnmBsSKv9AoJfxgEonwveSDdosx2g1g2" />

                    <div class="js-edit-form-partial">
                        


<input type="hidden" class="js-prev-country-id" value="25" />
<input type="hidden" class="js-prev-postalcode" value="1981" />

<input type="hidden" class="js-belgium-id" value="25" />

<input type="hidden" name="CountryId" value="25" class="js-country-id" />
<input type="hidden" name="CityName" value="Hofstade" class="js-city-name" />
<input type="hidden" name="PostalCode" value="1981" class="js-postalcode js-hidden-postalCode" />
<input type="hidden" name="StreetName" value="Muizenstraat" class="js-street-name" />

<div class="marg-bottom-sm-10">
    <select autocomplete="country-name" class="js-country-select&#32;js-country" data-ajax="/api/myaccountinfo/searchCountry?key=" data-isFuzzy="true" data-label="Land" data-labelstyle="stacked" data-minchars="2" data-noresults="Geen&#32;resultaten" data-search="True" data-triggerarrow="false" data-val="true" data-val-countryselected="Selecteer&#32;een&#32;land" data-val-required="Het&#32;land&#32;is&#32;verplicht" id="CountryName" name="CountryName"><option value="25">België</option>
</select>
    <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="CountryName" data-valmsg-replace="true"></span>
</div>

    <div class="row gutter-lg-30">
        <div class="col col-md-8 col-sm-12 marg-bottom-sm-10">
            <select autocomplete="address-level2" class="js-city-select&#32;js-city" data-ajax="/api/myaccountinfo/searchCity?countryId=25&amp;key=" data-ajax-pattern="/api/myaccountinfo/searchCity?countryId={country}&amp;key=" data-label="Stad" data-labelstyle="stacked" data-minchars="2" data-noresults="Geen&#32;resultaten" data-search="True" data-triggerarrow="false" data-val="true" data-val-belgiumcityselected="Selecteer&#32;een&#32;stad" data-val-required="De&#32;stad&#32;is&#32;verplicht" id="CityName" name="CityName"><option value="1981">Hofstade</option>
</select>
            <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="CityName" data-valmsg-replace="true"></span>
        </div>

        <div class="col col-md-4 col-sm-12 marg-bottom-sm-10">

            <select autocomplete="postal-code" class="js-postalcode-select&#32;js-postalcode" data-ajax="/api/myaccountinfo/searchPostcode?countryId=25&amp;key=" data-ajax-pattern="/api/myaccountinfo/searchPostcode?countryId={country}&amp;key=" data-label="Postcode" data-labelstyle="stacked" data-minchars="1" data-noresults="Geen&#32;resultaten" data-search="True" data-triggerarrow="false" data-val="true" data-val-belgiumcityselected="Selecteer&#32;een&#32;stad" data-val-required="De&#32;postcode&#32;is&#32;verplicht." id="PostalCode" name="PostalCode"><option selected="selected" value="1981">1981</option>
</select>
            <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="PostalCode" data-valmsg-replace="true"></span>
        </div>
    </div>
	<div class="marg-bottom-sm-20">
		<select autocomplete="street-address" class="js-street-select&#32;js-street" data-ajax="/api/myaccountinfo/SearchStreet?countryId=25&amp;postalCode=1981&amp;cityName=Hofstade&amp;key=" data-ajax-pattern="/api/myaccountinfo/SearchStreet?countryId={country}&amp;postalCode={postalCode}&amp;cityName={cityName}&amp;key=" data-label="Straat" data-labelstyle="stacked" data-minchars="2" data-noresults="Geen&#32;resultaten" data-search="True" data-triggerarrow="false" data-val="true" data-val-belgiumstreetselected="Selecteer&#32;een&#32;adres" data-val-required="De&#32;straatnaam&#32;is&#32;verplicht" id="StreetName" name="StreetName"><option selected="selected" value="Muizenstraat">Muizenstraat</option>
</select>
		<span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="StreetName" data-valmsg-replace="true"></span>
	</div>
<div class='row gutter-lg-20' style='padding-top:5px;'>
<div class="col col-sm-6">
    <div class="input marg-bottom-sm-10">
        <label class="input__lbl" for="StreetNumber">Nummer</label>
        <input autocomplete="off" class="input__txt&#32;js-input&#32;js-street-number" data-val="true" data-val-regex="" data-val-regex-pattern="^([1-9a-hj-np-zA-HJ-NP-Z]){1}(([0-9a-zA-Z])*)$" data-val-required="Een&#32;nummer&#32;is&#32;verplicht" id="StreetNumber" maxlength="8" name="StreetNumber" type="text" value="188" />
        <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="StreetNumber" data-valmsg-replace="true"></span>
    </div>
</div>
<div class="col col-sm-6">
	<div class="input marg-bottom-sm-10">
		<label class="input__lbl" for="PostBoxNumber">Bus</label>
		<input autocomplete="off" class="input__txt&#32;js-input" id="PostBoxNumber" maxlength="8" name="PostBoxNumber" type="text" value="" />
		<span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="PostBoxNumber" data-valmsg-replace="true"></span>
	</div>
</div>
        ...
        <button class="btn btn--secondary     link--nopad  js-submit-edit  marg-bottom-sm-40 marg-top-sm-40 hide-mobile" type="button" >
            ...
            Opslaan
                    ...
                    <input id="DataSourceId" name="DataSourceId" type="hidden" value="{E185EAE7-4BFC-4282-BB42-8D2965AD316C}" />
                </form>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="wrapper">
        <div class="marg-bottom-sm-30 marg-bottom-md-40 alternative-delivery-address-section ">
            <h2 class="display-inline-block">
                Alternatief adres
            </h2>
            <a href="javascript:void(0);" aria-label="" class="marg-left-sm-10 js-alternative-delivery-address-edit-button  personal-view-link">
                Bewerken
            </a>
                <br />
<?php echo nl2br(str_replace(',', "\n", $alt_email)); ?><br />
            <div id="alternative-delivery-address-edit" class="js-alternative-delivery-address-edit display-none marg-top-sm-20 marg-bottom-sm-10">
                <form class="form-alternative-delivery-address" action="/api/myaccountinfo/UpdateAlternativeDeliveryAddressInfo" id="alternativeDeliveryAddress" method="post">

                    <input name="__RequestVerificationToken" type="hidden" value="IAPr8kmDpMbON0nyZhXxaixiQ071Ii5jY0HOls-C14XdHYJzMuVnDPcLJp9SYqnEnqZJ5jOlzAoWFkdRCFsjifQlvalN1SP0-DlQw3kO2JfL0x-u100mRPRgLTNMmeP98HFY43wwa5fzzPBdEZylYg2" />
...
<input type="hidden" class="js-prev-country-id" value="25" />
<input type="hidden" class="js-prev-postalcode" value="" />

<input type="hidden" class="js-belgium-id" value="25" />

<input type="hidden" name="CountryId" value="25" class="js-country-id" />
<input type="hidden" name="CityName" class="js-city-name" />
<input type="hidden" name="PostalCode" value="" class="js-postalcode js-hidden-postalCode" />
<input type="hidden" name="StreetName" value="" class="js-street-name" />

<div class="marg-bottom-sm-10">
    <select autocomplete="country-name" class="js-country-select&#32;js-country" data-ajax="/api/myaccountinfo/searchCountry?key=" data-isFuzzy="true" data-label="Land" data-labelstyle="stacked" data-minchars="2" data-noresults="Geen&#32;resultaten" data-search="True" data-triggerarrow="false" data-val="true" data-val-countryselected="Selecteer&#32;een&#32;land" data-val-required="Het&#32;land&#32;is&#32;verplicht" id="CountryName" name="CountryName"><option value="25"></option>
</select>
    <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="CountryName" data-valmsg-replace="true"></span>
</div>
    ...
    <div class="row gutter-lg-30">
        <div class="col col-md-8 col-sm-12 marg-bottom-sm-10">
            <select autocomplete="address-level2" class="js-city-select&#32;js-city" data-ajax="/api/myaccountinfo/searchCity?countryId=25&amp;key=" data-ajax-pattern="/api/myaccountinfo/searchCity?countryId={country}&amp;key=" data-label="Stad" data-labelstyle="stacked" data-minchars="2" data-noresults="Geen&#32;resultaten" data-search="True" data-triggerarrow="false" data-val="true" data-val-belgiumcityselected="Selecteer&#32;een&#32;stad" data-val-required="De&#32;stad&#32;is&#32;verplicht" id="CityName" name="CityName"><option value=""></option>
</select>
            <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="CityName" data-valmsg-replace="true"></span>
        </div>
        ...
        <div class="col col-md-4 col-sm-12 marg-bottom-sm-10">
            ...
            <select autocomplete="postal-code" class="js-postalcode-select&#32;js-postalcode" data-ajax="/api/myaccountinfo/searchPostcode?countryId=25&amp;key=" data-ajax-pattern="/api/myaccountinfo/searchPostcode?countryId={country}&amp;key=" data-label="Postcode" data-labelstyle="stacked" data-minchars="1" data-noresults="Geen&#32;resultaten" data-search="True" data-triggerarrow="false" data-val="true" data-val-belgiumcityselected="Selecteer&#32;een&#32;stad" data-val-required="De&#32;postcode&#32;is&#32;verplicht." id="PostalCode" name="PostalCode"><option selected="selected" value=""></option>
</select>
            <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="PostalCode" data-valmsg-replace="true"></span>
        </div>
    </div>
	<div class="marg-bottom-sm-20">
		<select autocomplete="street-address" class="js-street-select&#32;js-street" data-ajax="/api/myaccountinfo/SearchStreet?countryId=25&amp;postalCode=&amp;cityName=&amp;key=" data-ajax-pattern="/api/myaccountinfo/SearchStreet?countryId={country}&amp;postalCode={postalCode}&amp;cityName={cityName}&amp;key=" data-label="Straat" data-labelstyle="stacked" data-minchars="2" data-noresults="Geen&#32;resultaten" data-search="True" data-triggerarrow="false" data-val="true" data-val-belgiumstreetselected="Selecteer&#32;een&#32;adres" data-val-required="De&#32;straatnaam&#32;is&#32;verplicht" id="StreetName" name="StreetName"><option selected="selected" value=""></option>
</select>
		<span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="StreetName" data-valmsg-replace="true"></span>
	</div>
<div class='row gutter-lg-20' style='padding-top:5px;'>
<div class="col col-sm-6">
    <div class="input marg-bottom-sm-10">
        <label class="input__lbl" for="StreetNumber">Nummer</label>
        <input autocomplete="off" class="input__txt&#32;js-input&#32;js-street-number" data-val="true" data-val-regex="" data-val-regex-pattern="^([1-9a-hj-np-zA-HJ-NP-Z]){1}(([0-9a-zA-Z])*)$" data-val-required="Een&#32;nummer&#32;is&#32;verplicht" id="StreetNumber" maxlength="8" name="StreetNumber" type="text" value="" />
        <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="StreetNumber" data-valmsg-replace="true"></span>
    </div>
</div>
<div class="col col-sm-6">
	<div class="input marg-bottom-sm-10">
        ...
        <button class="btn btn--secondary     link--nopad  js-submit-edit  marg-bottom-sm-40 marg-top-sm-40 hide-mobile" type="button" >
            ...
            Opslaan
                    ...
                    <input id="DataSourceId" name="DataSourceId" type="hidden" value="{8D0607B8-34FA-4DA8-B10C-AA64A741676F}" />
                </form>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="wrapper">
        <div class="marg-bottom-sm-30 marg-bottom-md-40">
            ...
            <a href="javascript:void(0);" aria-label="" class="marg-left-sm-10 js-contact-edit-button  personal-view-link">
	            Bewerken
            </a>
            <div id="contact-view" class="js-contact-view ">
                <div>
                </div>
                <div>
                    <label>Taal</label>
            ...
            <div id="contact-edit" class="js-contact-edit display-none marg-top-sm-20">
                <form action="/api/myaccountinfo/ContactInfo" method="post">

                    <input name="__RequestVerificationToken" type="hidden" value="PtU64oIjbnsora1BX6z52adeUb-IAXIKzwb_1DJfEWSNf2VGspJdUowLukE5qAZVjH1paP_Imu0natT6xVMC-QmGx9jsBz3XqUcmsSCwsnO_X3FO3J96siO2-_XZSi5HGgl2mqYLbghJ4MZpl1hTeA2" />

                    <div class="input marg-bottom-sm-10">
                        <label class="input__lbl" for="PrivatePhoneNumber">Privé telefoonnummer</label>
                        <input autocomplete="tel" class="input__txt&#32;js-input" data-val="true" data-val-regex="Het&#32;telefoonnummer&#32;is&#32;niet&#32;het&#32;correcte&#32;formaat" data-val-regex-pattern="^\d{9,10}$" id="PrivatePhoneNumber" name="PrivatePhoneNumber" type="text" value="" />
                        <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="PrivatePhoneNumber" data-valmsg-replace="true"></span>
                    </div>
                    <div class="input marg-bottom-sm-10  marg-top-sm-40">
                        <label class="input__lbl" for="PrivateMobileNumber">Privé gsm-nummer</label>
                        <input autocomplete="tel" class="input__txt&#32;js-input" data-val="true" data-val-regex="Het&#32;telefoonnummer&#32;is&#32;niet&#32;het&#32;correcte&#32;formaat" data-val-regex-pattern="^\d{9,10}$" id="PrivateMobileNumber" name="PrivateMobileNumber" type="text" value="" />
                        <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="PrivateMobileNumber" data-valmsg-replace="true"></span>
                    </div>
                    <div class="input marg-bottom-sm-10 marg-top-sm-40">
                        <select autocomplete="language" class="js-select" data-label="Taal" data-labelstyle="stacked" data-val="true" data-val-required="Selecteer&#32;een&#32;taal" id="Language" name="Language"><option selected="selected" value="Dutch">Nederlands</option>
<option value="French">Frans</option>
<option value="English">Engels</option>
<option value="German">Duits</option>
</select>
                        <span class="field-validation-valid&#32;frm__msg&#32;error" data-valmsg-for="Language" data-valmsg-replace="true"></span>
                    </div>
        ...
        <button class="btn btn--secondary     link--nopad  js-submit-edit  marg-bottom-sm-40 marg-top-sm-40 hide-mobile" type="button" >
            ...
            Opslaan
                    ...
                    <input id="DataSourceId" name="DataSourceId" type="hidden" value="{1A1733BD-1E67-46F3-8B0A-54A503167BC3}" />
                </form>
            </div>
        </div>
    </div>
...
<div class="container">
    <div class="wrapper">
        <div class="marg-bottom-sm-30 marg-bottom-md-40">
            ...
            <a href="javascript:void(0);" aria-label="" class="marg-left-sm-10 js-commercial-edit-button  personal-view-link">
	            Bewerken
            </a>

                <div id="commercial-view" class="marg-bottom-sm-10 js-commercial-view ">
Ik wil <strong>geen</strong> promoaanbiedingen en gepersonaliseerde inhoud van NMBS ontvangen.                </div>
                <div id="commercial-edit" class="js-commercial-edit display-none marg-top-sm-20">
                    <form action="/api/myaccountinfo/CommercialInfo" method="post">

                        <input name="__RequestVerificationToken" type="hidden" value="p0gtpO2sNpGvMfx7NazhzwRsvkh3M0k1NoXtQex2_Y9IcKNMikGotAd02p6dcxbrZVUcHDAj_0Q1pfp2N3uJMO1oc788w3xNRsE3-qA7YqSh_7UTHHH22EeqPeqStBgexFUmY2QWZ2Q0iUYIyjEntg2" />

                        <div class="chk">
                            <input class="chk__input" data-val="true" data-val-required="The&#32;SendPromo&#32;field&#32;is&#32;required." id="SendPromo" name="SendPromo" type="checkbox" value="true" /><input name="SendPromo" type="hidden" value="false" />
                            <div class="chk__check">
                                <svg class="icon input-checkmark" viewBox="0 0 52 52" focusable="false">
  <path class="input-checkmark__check" fill="none" d="M14.1 27.2l7.1 7.2 16.7-16.8"></path>
</svg>
                            </div>
                            <label for="SendPromo" class="chk__lbl">
                                Ik wil graag promoaanbiedingen en gepersonaliseerde inhoud ontvangen om op de hoogte te blijven van nieuws, promoties en reisinspiratie van NMBS.
                            </label>
                        </div>
        ...
        <button class="btn btn--secondary     link--nopad  js-submit-edit  marg-bottom-sm-40 marg-top-sm-40 hide-mobile" type="button" >
            ...
            Opslaan
                        ...
                        <input id="DataSourceId" name="DataSourceId" type="hidden" value="{BF84C6D7-59AB-4501-A9CA-2EA389A77CBC}" />
                    </form>
                </div>
        </div>
    </div>
...
<div class="container">
    <div class="wrapper">
        <div class="marg-bottom-sm-30 marg-bottom-md-40">
            ...
            <a href="javascript:void(0);" aria-label="" class="marg-left-sm-10 js-deleteaccount-edit-button  personal-view-link">
                Bewerken
            </a>

            <div id="deleteaccount-view" class="marg-bottom-sm-10 js-deleteaccount-view ">
                Door je MyNMBS-account te verwijderen, wis je permanent alle bijbehorende gegevens.
            </div>

            <div id="deleteaccount-edit" class="js-deleteaccount-edit display-none marg-top-sm-20">
                <form action="/api/myaccountinfo/DeleteAccountInfo" method="post" id="delete-account-form">

                    <input name="__RequestVerificationToken" type="hidden" value="Nc_QJfvCh11sOqpDUP_RRsWX5aTomk69Q-MhhVaIYFRAvFdkYA_wAEruVWH4mrtZdnp8ouO5Hk0zgAtuh_l3cENcPLCOsEbY7QnZ0oB0xR-tw62u6PJXewS3Er-sJdyO8CXBUfB5_ByBry3gMDJyog2" />



    <div class="alert alert--warning  alert--no-trigger  " data-open="true">
            <div class="alert__icon">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="icon color-orange-dark">
  <path d="M455.7 414.1c-4.7 7.9-12.6 12.6-21.3 11.9H77.1c-8.7 0-16.6-4.7-21.3-11.9-4.7-7.1-4.7-16.6 0-24.5L234.4 97.9C239.1 90.8 247 86 255.7 86c8.7 0 17.4 4.7 21.3 11.9l178.6 292.4c4 7.2 4 16.7.1 23.8zm42.6-49L319.7 73.4c-13.4-22.1-37.9-35.6-64-35.6-26.1-.8-50.6 12.6-64 35.6L13.9 365.1c-14.2 22.1-14.2 50.6-.8 72.7 13.4 22.9 37.9 36.4 64.8 36.4h355.6c26.9.8 51.4-13.4 64.8-36.4 14.3-22.2 14.3-50.6 0-72.7z" />
  <path d="M255.7 153.3c-13.4-.8-24.5 9.5-24.5 22.1v130.4c0 13.4 11.1 25.3 24.5 25.3S281 320 281 305.8v-128c-.8-13.5-11.9-24.5-25.3-24.5zm0 189.6c-13.4-.8-24.5 9.5-24.5 22.1v9.5c0 13.4 11.1 25.3 24.5 25.3s25.3-11.1 25.3-25.3v-7.9c0-13.4-10.3-23.7-22.9-24.5-1.6.8-1.6.8-2.4.8z" />
</svg>
        ...
        <div class="alert__content">
            ...
            <div class="alert__title">
                ...
                <div class="alert__extra" tabindex="0">
                    <p>Na deze stap worden je persoonlijke gegevens, aangekochte producten en beschikbare saldo op je e-wallet permanent gewist. Na verwijdering kan je geen reizigersattest meer genereren. Je verzoek zal binnen 3 werkdagen worden verwerkt.</p><br />
                    
                    


<a class="btn marg-bottom-sm-10 btn--default--orange  button   link--nopad   mobile-full-width marg-right-sm-20  show-popup-form param_bec8c356-fa69-4db1-8f2e-10a59783fdc1" title="Verwijder&#32;mijn&#32;account" href="/#">Verwijder mijn account</a>



<a class="btn marg-bottom-sm-10 btn--primary  button   link--nopad   mobile-full-width marg-right-sm-20  keep-my-account-active-action" title="Houd&#32;mijn&#32;account&#32;actief" href="/#">Houd mijn account actief</a>
                </div>
        </div>
    </div>
                    ...
                    <input id="DataSourceId" name="DataSourceId" type="hidden" value="{C466D458-3FBB-4025-9DD1-BC64ABB05FB2}" />
                </form>
            </div>
        </div>
    </div>
...
<div id="BEC8C356FA694DB18F2E10A59783FDC1" class="popup-with-form no-startendmargin theme-white hide"
      data-label-close="" 
     data-popup-form-button-position="text-right" data-alert-theme="theme-white" data-alert-popup="false"
     data-cta-action='show-popup-form'>
...
<form action="/form/Index?wffm.FormItemId=dc693206-3dc4-4b9c-895b-1bef6f1896b4&amp;wffm.Id=dc693206-3dc4-4b9c-895b-1bef6f1896b4" class="text-left" data-wffm="{DC693206-3DC4-4B9C-895B-1BEF6F1896B4}" data-wffm-ajax="True" enctype="multipart/form-data" id="wffmdc6932063dc44b9c895b1bef6f1896b4" method="post" role="form"><input name="__RequestVerificationToken" type="hidden" value="BQPNPkABmbB1aYXQfNRuuifvTE85sENHbvoxrlvSuQy7IPjFG5J8cOpaUaT0wF4wArsRf80LzGciDH9AS67XZcH94Z30mGHOGgt5etcsgeF_eYiznxdiNC2AvuzVKtcbd_6p2ujZSDcjC1cqmSct2Q2" /><input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Id" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Id" type="hidden" value="dc693206-3dc4-4b9c-895b-1bef6f1896b4" /><input id="wffmdc6932063dc44b9c895b1bef6f1896b4_FormItemId" name="wffmdc6932063dc44b9c895b1bef6f1896b4.FormItemId" type="hidden" value="{DC693206-3DC4-4B9C-895B-1BEF6F1896B4}" /><div class="page-header"><H1>Laat ons gerust weten waarom je besluit om je account te verwijderen.</H1></div>Klik hieronder op 'verzenden' om je verwijderingsverzoek te bevestigen.    <div class="has-error has-feedback">
      <div class="validation-summary-valid" data-valmsg-summary="true"><ul class="list-group"><li style="display:none"></li>
</ul></div>
    </div>
<div class="&#32;form-group"><input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_0__Id" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[0].Id" type="hidden" value="{7E2EAA80-E456-4D80-886E-F351D72DF34D}" /><label class="control-label" for="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_0__Value">Opties</label>        <div class="radio">
            <table>
                    <tr>
                            <td>
                                <label>
                                    <input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_0__Value" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[0].Value" type="radio" value="Ik&#32;heb&#32;het&#32;niet&#32;langer&#32;nodig" />
                    ...
                    <tr>
                            <td>
                                <label>
                                    <input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_0__Value" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[0].Value" type="radio" value="Ik&#32;heb&#32;een&#32;ander&#32;My&#32;NMBS-account" />
                                    Ik heb een ander My NMBS-account
                                </label>
                            </td>
                    </tr>
                    <tr>
                            <td>
                                <label>
                                    <input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_0__Value" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[0].Value" type="radio" value="Ik&#32;heb&#32;geen&#32;toegang&#32;meer&#32;tot&#32;mijn&#32;e-mailadres" />
                                    Ik heb geen toegang meer tot mijn e-mailadres
                                </label>
                            </td>
                    </tr>
                    <tr>
                            <td>
                                <label>
                                    <input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_0__Value" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[0].Value" type="radio" value="Mijn&#32;persoonlijke&#32;gegevens&#32;kloppen&#32;niet" />
                                    Mijn persoonlijke gegevens kloppen niet
                                </label>
                            </td>
                    </tr>
                    <tr>
                            <td>
                                <label>
                                    <input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_0__Value" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[0].Value" type="radio" value="Ik&#32;ondervind&#32;betalingsproblemen" />
                                    Ik ondervind betalingsproblemen
                                </label>
                            </td>
                    </tr>
                    <tr>
                            <td>
                                <label>
                                    <input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_0__Value" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[0].Value" type="radio" value="Andere" />
                                    Andere
                                </label>
                            </td>
                    </tr>
...
<span class="field-validation-valid&#32;help-block" data-valmsg-for="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[0].Value" data-valmsg-replace="true"></span></div><div class="&#32;form-group"><input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_1__Id" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[1].Id" type="hidden" value="{09D7EDC0-D820-4C97-A99D-38EDEAA74976}" /><label class="control-label" for="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_1__Value">Andere (geef aub meer details)</label><textarea class="form-control" cols="1" data-val="true" data-val-length="" data-val-length-max="50" id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_1__Value" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[1].Value" rows="4">
</textarea><span class="field-validation-valid&#32;help-block" data-valmsg-for="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[1].Value" data-valmsg-replace="true"></span></div>
<input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_2__Value" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[2].Value" type="hidden" value="" />
<input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_3__Value" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[3].Value" type="hidden" value="" />
<input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_4__Value" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[4].Value" type="hidden" value="" />
<input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_5__Value" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[5].Value" type="hidden" value="" />
<div class="&#32;form-group"><input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_6__Id" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[6].Id" type="hidden" value="{0000AD1F-8DB2-464C-868F-8861BDEF2892}" /><input id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_6__Value" name="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[6].Value" type="hidden" value="nl" /><span class="field-validation-valid&#32;help-block" data-valmsg-for="wffmdc6932063dc44b9c895b1bef6f1896b4.Sections[0].Fields[6].Value" data-valmsg-replace="true"></span></div><div class="form-submit-border"><input class="btn&#32;&#32;btn-default" type="submit" value="Verzenden"></input></div></form>


<script data-cfasync="false" src="/cdn-cgi/scripts/5c5dd728/cloudflare-static/email-decode.min.js"></script><script src="/sitecore%20modules/Web/Web%20Forms%20for%20Marketers/mvc/libs/jquery/jquery-3.2.1.min.js"></script>
...
<script src="/sitecore%20modules/Web/Web%20Forms%20for%20Marketers/mvc/main.min.js"></script>
            ...
            <div class="popup-with-form-buttons" style="display:none;">



<a class="btn marg-bottom-sm-10 btn--secondary  button   link--nopad   popup-with-form-button-include mobile-full-width submit-popup-form-action close-delete-my-account-section-action" title="Verzenden" href="/#">Verzenden</a>

            </div>
            <div class="alert alert--no-trigger alertErrorDetails" style="display:none;">
                <div class="alert__content">
                        <div class="h3">
                            Oeps, er liep iets fout...
                        </div>
                                            <div class="alert__title">
                            Door een technisch probleem tijdens het verwerken van je aanvraag zijn je gegevens mogelijk niet opgeslagen. Probeer het later opnieuw.
                        </div>
                </div>
            </div>
		    <div class="alert alert--no-trigger alertSuccessDetails" style="display:none;">
			    <div class="alert__content">
					    <div class="h3">
						    Aanvraag succesvol verzonden
					    </div>
				    					    <div class="alert__title">
						    Je aanvraag om je account te verwijderen werd succesvol verzonden. We komen zo snel mogelijk bij je terug.
					    </div>
			    </div>
		    </div>
        ...
        <input type="hidden" class="data-auto-fill-info" data-auto-fill-id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_2__Value" data-auto-fill-values="Kenneth" />
        <input type="hidden" class="data-auto-fill-info" data-auto-fill-id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_3__Value" data-auto-fill-values="Van Velthoven" />
        <input type="hidden" class="data-auto-fill-info" data-auto-fill-id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_4__Value" data-auto-fill-values="omgt2k@hotmail.com" />
        <input type="hidden" class="data-auto-fill-info" data-auto-fill-id="wffmdc6932063dc44b9c895b1bef6f1896b4_Sections_0__Fields_5__Value" data-auto-fill-values="30-10-1983" />
...
<div class="footer__service">
    <div class="container">
            ...
            <h2 class="h1">Heb je een vraag?</h2>


        <ul class="row gutter-md-20 gutter-20 gutter-lg-40 flex-d flex-wrap footer__list">
                        <li class="col col-xs-12 col-md-6 col-xl-4 footer__list-item">
                                ...
                                <div class="footer__item ">
                                        ...
                                        <div class="footer__list ">
                                                                <div class="footer__list-item  ">
                                                                    <a href="/nl/support/customer-service" class="footer__icolink "><div class='icon__holder icon-login-color'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class=" icon icon-login">
  <path d="M255 509C115.4 507.6 2.9 394 3 254.4 4.7 115.2 117.9 3.3 257 3c139.6 1.4 252 115 252 254.6-1.7 139.2-114.9 251.1-254 251.4zm-39.6-225.1c-51.8-36.4-69.7-75.9-55.6-122.3 19.1-52.2 76.8-79 129-60s79 76.8 60 129c-9.8 24-28.7 43.2-52.7 53.1 68 25.3 107.1 72 113.7 144 61.1-49 100-146.8 67.5-244.6C437.5 61 306.3-5.7 184.2 34.1 108.9 58.8 51.3 119.9 31.3 196.4c-25.8 94.1 15.5 188.2 71.5 230.9 5.9-72.6 44.2-119.8 112.6-143.4z" />
</svg></div>Klantendienst</a>
                                                                </div>
                        ...
                        <li class="col col-xs-12 col-md-6 col-xl-4 footer__list-item">
                                ...
                                <div class="footer__item ">
                                        ...
                                        <div class="footer__list ">
                                                                <div class="footer__list-item  ">
                                                                    <a href="/nl/support/search-website" class="footer__icolink "><div class='icon__holder icon-question-color'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class=" icon icon-question">
  <path d="M256 504C119.3 504 8 392.7 8 256S119.3 8 256 8s248 111.3 248 248-111.3 248-248 248zm0-446.4c-109.4 0-198.4 89-198.4 198.4s89 198.4 198.4 198.4 198.4-89 198.4-198.4S365.4 57.6 256 57.6z" />
  <path d="M228.4 312.4c-.8-5.2-1.6-10.4-1.6-16.3 0-21.1 8.7-40.5 31.4-57.6l19-14.3c11.9-8.7 17.1-19.4 17.1-31.4 0-18.3-13.1-35.7-39.7-35.7-28.2 0-40.5 22.6-40.5 44.9 0 4.8.4 9.1 1.6 12.7l-50-2c-1.6-5.6-2-11.9-2-17.9 0-42.9 32.1-84.2 90.9-84.2 61.5 0 93.7 38.9 93.7 79 0 31.4-15.9 53.6-39.3 70.3l-16.3 11.5c-13.9 9.9-21.4 22.2-21.4 38.5v2.4l-42.9.1zm22.2 25.8c17.5.1 31.7 14.3 31.8 31.8 0 17.4-14.3 31.3-31.8 31.3s-31.4-13.9-31.4-31.3c.1-17.5 14-31.8 31.4-31.8z" />
</svg></div>Zoeken op deze site</a>
                                                                </div>
                        ...
                        <li class="col col-xs-12 col-md-6 col-xl-4 footer__list-item">
                                ...
                                <div class="footer__item ">
                                        ...
                                        <div class="footer__list ">
                                                                <div class="footer__list-item  ">
                                                                    <a href="/nl/support/faq" class="footer__icolink "><div class='icon__holder icon-menu-color'><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class=" icon icon-menu">
  <path d="M492.2 119.3H19.8c-9.4-.7-16.4-8.9-15.8-18.3-.6-9.4 6.4-17.5 15.7-18.3h472.4c9.4.8 16.4 8.9 15.7 18.3.8 9.4-6.2 17.6-15.6 18.3zm0 155H19.8c-9.4-.8-16.4-8.9-15.8-18.3-.6-9.4 6.4-17.5 15.7-18.3h472.4c9.4.8 16.4 8.9 15.7 18.3.8 9.4-6.2 17.5-15.6 18.3zm0 154.9H19.8c-9.4-.7-16.4-8.9-15.8-18.2-.6-9.4 6.4-17.5 15.7-18.3h472.4c9.4.8 16.4 8.9 15.7 18.3.8 9.3-6.2 17.5-15.6 18.2z" />
</svg></div>Veelgestelde vragen</a>
                                                                </div>
